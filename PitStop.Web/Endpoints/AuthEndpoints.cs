...
internal static class AuthEndpoints
{
    ...
    private static async Task<IResult> DoRegister(HttpContext ctx, UserManager<ApplicationUser> userMgr, SignInManager<ApplicationUser> signInMgr)
    {
        var form            = await ctx.Request.ReadFormAsync();
    ...
    private static async Task<IResult> DoForgotPassword(HttpContext ctx, UserManager<ApplicationUser> userMgr, IEmailService emailSvc)
    {
        var form  = await ctx.Request.ReadFormAsync();
    ...
    private static async Task<IResult> DoSetPassword(HttpContext ctx, UserManager<ApplicationUser> userMgr, SignInManager<ApplicationUser> signInMgr)
    {
        var form            = await ctx.Request.ReadFormAsync();
    ...
    private static async Task<IResult> GoogleCallback(HttpContext ctx, UserManager<ApplicationUser> userMgr, SignInManager<ApplicationUser> signInMgr)
    {
